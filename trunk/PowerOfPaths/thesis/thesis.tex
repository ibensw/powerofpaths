...
Algorithm & \multicolumn{2}{|p{0.8\textwidth}|}{Forward right, Left/Right, Random left/right (0.5), Random unvisited, Random Coprime offset} \\ \hline
...
\begin{figure}[h!tb]
\centering
\includegraphics[width=0.6\textwidth]{data/4rightright.pdf}
\caption{Forward Right, 4 cpu's vs 1}
\label{figevenswitch}
\end{figure}

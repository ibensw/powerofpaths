...
%We see this method is an approximation to the results of multiple CPUs, but it performs better. This is because the the approximation is not analogue to the real algorithm. When using multiple CPUs, the choice of the first $c$ CPUs is fixed, w
